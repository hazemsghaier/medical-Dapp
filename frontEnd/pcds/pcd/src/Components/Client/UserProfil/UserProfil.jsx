...
import Header from '../UserSpace/Header'; // Import your Header component
import Propre from '../UserSpace/Propre'; // Import your Propre component
import Footer from '../../Footer/Footer';
import {getUserData} from "../../../api/clientApi"
...
const UserProfil = () => {
  ...
  const [doctor, setDoctor] = useState('hazem Sghaier');
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if(result.docteurEmail){
          setDoctor(result.docteurEmail);
        }
